...
public class Lab1servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String usrname = request.getParameter("txtusrname");
        String pswd = request.getParameter("txtpassword");
         response.setContentType("text/HTML");
        PrintWriter out = response.getWriter();
       out.println("<h2> Servlet displaying accepted username and password");
        out.println("<h2> Username : " + usrname + "</h2>");
        out.println("<h2> Username : " + pswd + "</h2>");
